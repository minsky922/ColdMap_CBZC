...
class ZenFSLogger : public Logger {
 public:
  ZenFSLogger(ZenFS* zenfs, std::unique_ptr<FSWritableFile> writable_file,
 ...
 private:
  ...
  class FileOpGuard {
   public:
    explicit FileOpGuard(ZenFSLogger& logger)
  ...
  void Flush() override {
    // TEST_SYNC_POINT("ZenFSLogger::Flush:Begin1");
    // TEST_SYNC_POINT("ZenFSLogger::Flush:Begin2");
